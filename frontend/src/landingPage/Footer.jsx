...
export default function Footer() {
    return (
        <div className="container bg-light border-top mt-5">
            <div className="row mt-5">
                <div className="col">
                    <img className="pb-2" src="/images/logo.svg" alt="logo" style={{ width: "50%" }} />
                ...
                <div className="col">
                    ...
                    <br />
                    <a href="" className="footerLinks">Zerodha.tech</a>
                    <br />
                    <a href="" className="footerLinks">Press & Media</a>
                    <br />
                    <a href="" className="footerLinks">Zerodha cares (CSR)</a>
                </div>
                <div className="col">
                    <h4>Support</h4>
